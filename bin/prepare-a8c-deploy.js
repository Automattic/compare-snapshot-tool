...
const targetCssFilename = 'compare-snapshot.bundle.css';
const targetCssMapFilename = 'compare-snapshot.bundle.css.map';
const targetJsFilename = 'compare-snapshot.bundle.js';
const targetJsMapFilename = 'compare-snapshot.bundle.js.map';
...
if ( ! modifiedCss.endsWith( '/*# sourceMappingURL=compare-snapshot.bundle.css.map*/' ) ) {
...
if ( ! modifiedJs.endsWith( '//# sourceMappingURL=compare-snapshot.bundle.js.map' ) ) {
